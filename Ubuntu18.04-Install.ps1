#
# Deploy the Azure Canonical SKU  Ubuntu Server 18.04
#
# History
# 0.1  08.10.2019   dcasota Initial release
#
# SKU
...
$productversion = "18.04.201909140"
